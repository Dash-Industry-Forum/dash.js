        ...
        for(var index = 0; index <10; index++){
            ...
            switch(key){
                ...
                case 'roleVideo':
                    ...
                    break;
                case 'languageText':
                    $scope.initialSettings.text = value
                    $scope.player.setInitialMediaSettingsFor('text', {
