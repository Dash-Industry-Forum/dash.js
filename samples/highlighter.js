...
codeOutput.innerHTML += '<div style="margin-top: 30px; display: block; width: 100%;"><p style=" font-weight: bold; font-size: 1.1em; display: flex; justify-content: space-between; align-items: center;">Source code<button id="clipboard-copy" class="btn btn-secondary">Copy to clipboard</button></p><pre style="border: solid 1px #ddd"><code class="html javascript" id="code"></code></pre></div>';
