    ...
    var index = -1,
        ...
        getSegments = function (representation) {
            ...
            if (representation.hasOwnProperty("SegmentTemplate") && !representation.SegmentTemplate.hasOwnProperty("SegmentTimeline")) {
                ...
                if (representation.hasOwnProperty("segments") && representation.segments !== null) {
                    ...
                    if (representation.hasOwnProperty("SegmentTemplate") && representation.SegmentTemplate.hasOwnProperty("SegmentTimeline")) {
                        return getSegmentsFromTimeline.call(this, representation.SegmentTemplate, representation.SegmentTemplate.SegmentTimeline);
                    }
                    else if (representation.hasOwnProperty("SegmentList")) {
                        return getSegmentsFromList.call(this, representation.SegmentList);
                    }
                    else {
                        return getSegmentsFromSource.call(this, representation);
                    }
                }
            }
        },
        ...
        getIndexForSegments = function (time, segments) {
            ...
            if (segments) {
                ...
                while (ft <= time && idx < segments.length) {
                    idx += 1;
                    frag = segments[idx];
        ...
        getRequestForTemplate = function (index, template, representation) {
            ...
            request.duration = template.duration;
            request.startTime = tIdx * template.duration;
            ...
            getSegments.call(self, representation).then(
                function (segments) {
                    ...
                    if (segments === null) {
                        ...
                        return getIndexForTemplate.call(self, time, representation.SegmentTemplate);
                    } else {
                        self.debug.log("Got a list of segments, so dig deeper.");
                        representation.segments = segments;
                        usingTemplate = false;
                        return getIndexForSegments.call(self, time, segments);
                    }
                }
            ).then(
                function (newIndex) {
                ...
                function (finished) {
                    ...
                    if (finished) {
                        ...
                        if (usingTemplate) {
                            return getRequestForTemplate.call(self, index, representation.SegmentTemplate, representation);
                        } else {
                            segment = representation.segments[index];
                            return getRequestForSegment.call(self, index, segment, representation);
                        }
                    }
                }
            ).then(
