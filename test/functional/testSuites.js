...
const textSwitching = require('./tests/textSwitching');
const ended = require('./tests/ended');

var registerSuites = function (stream) {
    var suites = intern.config.testSuites || ['playFromTime', 'pause', 'seek', 'seekPeriods', 'textSwitching', 'ended'];
    ...
    if (suites.indexOf('textSwitching') !== -1) textSwitching.register(stream);
