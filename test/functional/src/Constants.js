...
TESTCASES.PLAYBACK.ATTACH_AT_NON_ZERO = TESTCASES.CATEGORIES.PLAYBACK + '_attach_at_non_zero';
TESTCASES.PLAYBACK.ATTACH_WITH_POSIX = TESTCASES.CATEGORIES.PLAYBACK + '_simple_attach_with_posix';
TESTCASES.PLAYBACK.ENDED = TESTCASES.CATEGORIES.PLAYBACK + '_ended';
TESTCASES.PLAYBACK.MPD_ANCHOR = TESTCASES.CATEGORIES.PLAYBACK + '_mpd_anchor';
TESTCASES.PLAYBACK.MULTIPERIOD_PLAYBACK = TESTCASES.CATEGORIES.PLAYBACK + '_multiperiod_playback';
