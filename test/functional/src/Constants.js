...
TESTCASES.DODGE.PLAY_DEFENDED = TESTCASES.CATEGORIES.DODGE + 'play-defended';
TESTCASES.DODGE.DEFENSE_VERIFICATION = TESTCASES.CATEGORIES.DODGE + 'defense-verification';
TESTCASES.DODGE.STRICT_MODE_REJECTS_MPD = TESTCASES.CATEGORIES.DODGE + 'strict-mode-rejects-mpd';
TESTCASES.DODGE.STRICT_MODE_ALLOWS_EXMFST = TESTCASES.CATEGORIES.DODGE + 'strict-mode-allows-exmfst';
TESTCASES.DODGE.GRACEFUL_DEGRADATION = TESTCASES.CATEGORIES.DODGE + 'graceful-degradation';
TESTCASES.DODGE.TRAILING = TESTCASES.CATEGORIES.DODGE + 'trailing';

TESTCASES.DODGE.REPRESENTATION_STRICT_MODE = TESTCASES.CATEGORIES.DODGE + 'representation-strict-mode';
TESTCASES.DODGE.THUMBNAIL_DETECTION = TESTCASES.CATEGORIES.DODGE + 'thumbnail-detection';
TESTCASES.DODGE.TEXT_TRACK_BLOCKING = TESTCASES.CATEGORIES.DODGE + 'text-track-blocking';
TESTCASES.DODGE.XLINK_DETECTION = TESTCASES.CATEGORIES.DODGE + 'xlink-detection';
TESTCASES.DODGE.SIDE_CHANNEL_POLICY = TESTCASES.CATEGORIES.DODGE + 'side-channel-policy';

TESTCASES.DODGE.QUALITY_OVERRIDE = TESTCASES.CATEGORIES.DODGE + 'quality-override';
TESTCASES.DODGE.MULTIPERIOD = TESTCASES.CATEGORIES.DODGE + 'multiperiod';
TESTCASES.DODGE.SEEK = TESTCASES.CATEGORIES.DODGE + 'seek';
TESTCASES.DODGE.SEEK_BACKWARD = TESTCASES.CATEGORIES.DODGE + 'seek-backward';
TESTCASES.DODGE.SEEK_TRAILING = TESTCASES.CATEGORIES.DODGE + 'seek-trailing';
TESTCASES.DODGE.MOCK_BUFFER = TESTCASES.CATEGORIES.DODGE + 'mock-buffer';
TESTCASES.DODGE.EXTENDED_TRAILING = TESTCASES.CATEGORIES.DODGE + 'extended-trailing';
