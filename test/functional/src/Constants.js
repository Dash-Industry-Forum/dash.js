...
const TEST_TIMEOUT_THRESHOLDS = {
    ...
    TARGET_BUFFER_REACHED: 30000,
    BUFFER_STABLE_WINDOW: 15000,
...
const TEST_INPUTS = {
    ...
    BUFFER_TARGET: {
        ...
        LONG_FORM_BUFFER: 20,
        TOLERANCE: 2,
        FORCE_SHORT_FORM_THRESHOLD: 100000,
        FORCE_LONG_FORM_THRESHOLD: 0
    },
    LIVE_DELAY: {
        VALUE: 10,
        TOLERANCE: 2
...
TESTCASES.FEATURE_SUPPORT.CMCD_V2 = TESTCASES.CATEGORIES.FEATURE_SUPPORT + 'cmcd-v2';
...
TESTCASES.PLAYBACK_ADVANCED.MULTIPERIOD_BUFFER_REUSE = TESTCASES.CATEGORIES.PLAYBACK_ADVANCED + 'multiperiod-buffer-reuse';
TESTCASES.PLAYBACK_ADVANCED.PRELOAD = TESTCASES.CATEGORIES.PLAYBACK_ADVANCED + 'preload';
TESTCASES.PLAYBACK_ADVANCED.PRELOAD_SINGLE_PERIOD_PLAY_MULTIPERIOD = TESTCASES.CATEGORIES.PLAYBACK_ADVANCED + 'preload-singleperiod-play-multiperiod';
