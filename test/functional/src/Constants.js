...
TESTCASES.BUFFER.INITIALTARGET = TESTCASES.CATEGORIES.BUFFER + 'initial-buffer-target';
...
TESTCASES.PLAYBACK_ADVANCED.ATTACH_WITH_POSIX = TESTCASES.CATEGORIES.PLAYBACK_ADVANCED + 'simple-attach-with-posix';
