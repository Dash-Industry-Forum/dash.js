...
class VoHelper {
    ...
    createRepresentation(type) {
        ...
        rep.initialization = '//dash.akamaized.net/envivio/dashpr/clear/video4/Header.m4s';
    ...
    createRequest(type) {
        ...
        req.mediaType = 'video';
        req.type = type;
        req.url = '//dash.akamaized.net/envivio/dashpr/clear/video4/Header.m4s';
        req.startTime = NaN;
        req.duration = NaN;

        if (type === HTTPRequest.MEDIA_SEGMENT_TYPE) {
            req.url = '//dash.akamaized.net/envivio/dashpr/clear/video4/0.m4s';
            req.startTime = 0;
            req.duration = 4;
            req.index = 0;
