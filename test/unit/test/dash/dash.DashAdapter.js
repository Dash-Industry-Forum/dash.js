...
describe('DashAdapter', function () {
    ...
    describe('SetConfig previously called', function () {
        ...
        describe('getFragmentDurationForLiveDelayCalculation', function () {
            const streamInfo = { id: 'defaultId_0', index: 0 };
            ...
            it('should return the full segment duration when only some adaptation sets use partial segments', function () {
                ...
                expect(dashAdapter.getFragmentDurationForLiveDelayCalculation(streamInfo, { maxFragmentDuration: 8 })).to.equal(8);
            });
            ...
            it('should return the partial segment duration when all adaptation sets use partial segments', function () {
                ...
                expect(dashAdapter.getFragmentDurationForLiveDelayCalculation(streamInfo, { maxFragmentDuration: 8 })).to.equal(0.5);
            });
            ...
            it('should fall back to manifestInfo.maxFragmentDuration without partial segments', function () {
                ...
                expect(dashAdapter.getFragmentDurationForLiveDelayCalculation(streamInfo, { maxFragmentDuration: 6 })).to.equal(6);
            });
            ...
            it('should return NaN when no periods and no manifestInfo are available', function () {
                expect(dashAdapter.getFragmentDurationForLiveDelayCalculation(streamInfo, undefined)).to.be.NaN;
            });
        });
