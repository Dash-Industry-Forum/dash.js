...
describe('ThroughputRule', function () {
    ...
    it("should throw an exception when attempting to call getMaxIndex While the config attribute has not been set properly", function () {
        expect(throughputRule.getMaxIndex.bind(throughputRule, {getMediaType : {}, getMediaInfo: {}, hasRichBuffer: {}, getAbrController: {}, getStreamProcessor: {}})).to.throw('Missing config parameter(s)');
    });
}); 