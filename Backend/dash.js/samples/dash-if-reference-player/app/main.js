...
angular
    .module("DashSourcesService", ["ngResource"])
    .factory("sources", function ($resource) {
        /* jshint ignore:line */ return $resource(
            "app/sources.json",
            {},
            {
                query: {
...
angular
    .module("DashContributorsService", ["ngResource"])
...
angular
    .module("DashIFTestVectorsService", ["ngResource"])
    .factory("dashifTestVectors", function ($resource) {
        /* jshint ignore:line */ return $resource(
            "https://testassets.dashif.org/dashjs.json",
            {},
            {
                query: {
                    method: "GET",
...
app.controller("DashController", [
    ...
    "contributors",
    "dashifTestVectors",
    function ($scope, $window, sources, contributors, dashifTestVectors) {
        $scope.selectedItem = {
            // url: "https://dash.akamaized.net/akamai/bbb_30fps/bbb_30fps.mpd1",
            url: "../../../manifest/live.mpd",
        };
        ...
        sources.query(function (data) {
            ...
            if (typeof MssHandler !== "function") {
                for (var i = $scope.availableStreams.length - 1; i >= 0; i--) {
                    if (
                        $scope.availableStreams[i].name === "Smooth Streaming"
                    ) {
                ...
                if (item && item.submenu && item.submenu.length > 0) {
                    item.submenu.forEach(function (subitem) {
                        if (
                            ...
                            provider[subitem.provider].acronym
                        ) {
                            subitem.name =
                                "[" +
                                provider[subitem.provider].acronym +
            ...
            legend: {
                ...
                labelFormatter: function (label, series) {
                    return (
                        ...
                        "." +
                        series.id +
                        '" onclick="legendLabelClickHandler(this)">' +
                        label +
                        "</div>"
                    );
                },
        ...
        $scope.abrThroughputCalculationMode =
        ...
        window.player = $scope.player = dashjs
            .MediaPlayer()
            .create(); /* jshint ignore:line */
                ...
                if (!e.event) {
                    $scope.$apply(function () {
                        ...
                        switch (e.error.code) {
                            ...
                            case dashjs
                                .MediaPlayer.errors.XLINK_LOADER_LOADING_FAILURE_ERROR_CODE:
                            case dashjs
                                .MediaPlayer.errors.SEGMENT_BASE_LOADER_ERROR_CODE:
                            case dashjs
                                .MediaPlayer.errors.TIME_SYNC_FAILED_ERROR_CODE:
                            case dashjs
                                .MediaPlayer.errors.FRAGMENT_LOADER_LOADING_FAILURE_ERROR_CODE:
                            case dashjs
                                .MediaPlayer.errors.FRAGMENT_LOADER_NULL_REQUEST_ERROR_CODE:
                            case dashjs
                                .MediaPlayer.errors.URL_RESOLUTION_FAILED_GENERIC_ERROR_CODE:
                            case dashjs.MediaPlayer.errors.APPEND_ERROR_CODE:
                            case dashjs.MediaPlayer.errors.REMOVE_ERROR_CODE:
                            case dashjs
                                .MediaPlayer.errors.DATA_UPDATE_FAILED_ERROR_CODE:
                            case dashjs
                                .MediaPlayer.errors.CAPABILITY_MEDIASOURCE_ERROR_CODE:
                            case dashjs
                                .MediaPlayer.errors.CAPABILITY_MEDIAKEYS_ERROR_CODE:
                            case dashjs
                                .MediaPlayer.errors.DOWNLOAD_ERROR_ID_SIDX:
                            case dashjs
                                .MediaPlayer.errors.MANIFEST_ERROR_ID_CODEC:
                            case dashjs
                                .MediaPlayer.errors.MANIFEST_ERROR_ID_PARSE:
                            case dashjs
                                .MediaPlayer.errors.MANIFEST_ERROR_ID_NOSTREAMS:
                            case dashjs
                                .MediaPlayer.errors.TIMED_TEXT_ERROR_ID_PARSE:
                            // mss errors
                            case dashjs.MediaPlayer.errors.MSS_NO_TFRF_CODE:
                            // protection errors
                            case dashjs.MediaPlayer.errors.MEDIA_KEYERR_CODE:
                            case dashjs
                                .MediaPlayer.errors.MEDIA_KEYERR_UNKNOWN_CODE:
                            case dashjs
                                .MediaPlayer.errors.MEDIA_KEYERR_CLIENT_CODE:
                            case dashjs
                                .MediaPlayer.errors.MEDIA_KEYERR_SERVICE_CODE:
                            case dashjs
                                .MediaPlayer.errors.MEDIA_KEYERR_OUTPUT_CODE:
                            case dashjs
                                .MediaPlayer.errors.MEDIA_KEYERR_HARDWARECHANGE_CODE:
                            case dashjs
                                .MediaPlayer.errors.MEDIA_KEYERR_DOMAIN_CODE:
                                break;
                        }
                    });
        ...
        var initVideoTrackSwitchMode =
            currentConfig.streaming.trackSwitchMode.video;
        var initAudioTrackSwitchMode =
            currentConfig.streaming.trackSwitchMode.audio;
        ...
        $scope.controlbar = new ControlBar(
            $scope.player
        ); /* jshint ignore:line */
        ...
        $scope.player.on(
            ...
            function (e) {
                var bitrate = Math.round(
                    e.currentRepresentation.bandwidth / 1000
                );

                $scope[e.mediaType + "PendingIndex"] =
                    e.currentRepresentation.index + 1;
                $scope[e.mediaType + "PendingMaxIndex"] =
        ...
        $scope.player.on(
            dashjs.MediaPlayer.events.PERIOD_SWITCH_COMPLETED,
            function (e) {
                /* jshint ignore:line */
        ...
        $scope.player.on(
            ...
            function (e) {
                ...
                stopMetricsInterval();
                $scope.videoQualities =
                    $scope.player.getBitrateInfoListFor("video");
                $scope.chartCount = 0;
        ...
        $scope.player.on(
            ...
            function (e) {
                /* jshint ignore:line */
                if ($("#loop-cb").is(":checked") && e && e.isLast) {
                    $scope.doLoad();
                }
            },
            $scope
        ...
        $scope.player.on(
            dashjs.MediaPlayer.events.KEY_SYSTEM_SELECTED,
            function (e) {
                /* jshint ignore:line */
                if (e.data) {
        ...
        $scope.player.on(
            dashjs.MediaPlayer.events.KEY_SESSION_CREATED,
            function (e) {
                /* jshint ignore:line */
                if (e.data) {
                    var session = e.data;
                    if (session.getSessionType() === "persistent-license") {
                        $scope.persistentSessionId[$scope.selectedItem.url] =
        ...
        $scope.player.on(
            dashjs.MediaPlayer.events.CONFORMANCE_VIOLATION,
            function (e) {
                /* jshint ignore:line */
                if (
                    e &&
                    e.event &&
                    e.event.key &&
                    !$scope.conformanceViolations[e.event.key]
                ) {
                    var existingViolation = $scope.conformanceViolations.filter(
                        function (violation) {
        ...
        $scope.changeABRStrategy = function (strategy) {
            ...
            if (strategy === "abrLoLP") {
                ...
                $scope.changeFetchThroughputCalculation(
                    "abrFetchThroughputCalculationMoofParsing"
                );
                ...
                streaming: {
                    delay: {
                        useSuggestedPresentationDelay:
                            $scope.useSuggestedPresentationDelay,
                    },
                },
            });
        };
        ...
        $scope.toggleForceQualitySwitch = function () {
            $scope.controlbar.forceQualitySwitch(
                $scope.forceQualitySwitchSelected
            );
        };
                        ...
                        additionalAbrRules: {
                            insufficientBufferRule:
                                $scope.additionalAbrRules
                                    .insufficientBufferRule,
                            switchHistoryRule:
                                $scope.additionalAbrRules.switchHistoryRule,
                            droppedFramesRule:
                                $scope.additionalAbrRules.droppedFramesRule,
                            abandonRequestsRule:
                                $scope.additionalAbrRules.abandonRequestsRule,
                        },
                    },
                },
            });
        ...
        $scope.toggleCalcSegmentAvailabilityRangeFromTimeline = function () {
            $scope.player.updateSettings({
                streaming: {
                    timeShiftBuffer: {
                        calcFromSegmentTimeline:
                            $scope.calcSegmentAvailabilityRangeFromTimelineSelected,
                    },
                },
            });
        };
                ...
                streaming: {
                    buffer: {
                        reuseExistingSourceBuffers:
                            $scope.reuseExistingSourceBuffersSelected,
                    },
                },
            });
        };
        ...
        $scope.updateLiveDelayFragmentCount = function () {
            $scope.player.updateSettings({
                streaming: {
                    delay: {
                        liveDelayFragmentCount: parseInt(
                            $scope.liveDelayFragmentCount
                        ),
                    },
                },
            });
        ...
        $scope.toggleText = function () {
            $scope.player.updateSettings({
                streaming: {
                    text: {
                        defaultEnabled: $scope.initialSettings.textEnabled,
                    },
                },
            });
        };
        ...
        $scope.toggleForcedTextStreaming = function () {
            $scope.player.enableForcedTextStreaming(
                $scope.initialSettings.forceTextStreaming
            );
        };
        ...
        $scope.doLoad = function () {
                ...
                streaming: {
                    buffer: {
                        ...
                        bufferTimeAtTopQuality:
                            $scope.defaultBufferTimeAtTopQuality,
                        bufferTimeAtTopQualityLongForm:
                            $scope.defaultBufferTimeAtTopQualityLongForm,
                    },
                    delay: {
            ...
            if ($scope.selectedItem.hasOwnProperty("bufferConfig")) {
                ...
                if (selectedConfig.stableBufferTime) {
                    config.streaming.buffer.stableBufferTime =
                        selectedConfig.stableBufferTime;
                }

                if (selectedConfig.bufferTimeAtTopQuality) {
                    config.streaming.buffer.bufferTimeAtTopQuality =
                        selectedConfig.bufferTimeAtTopQuality;
                }

                if (selectedConfig.bufferTimeAtTopQualityLongForm) {
                    config.streaming.buffer.bufferTimeAtTopQualityLongForm =
                        selectedConfig.bufferTimeAtTopQualityLongForm;
                }
            }

            const liveDelayFragmentCount = parseInt(
                $scope.liveDelayFragmentCount
            );
            if (!isNaN(liveDelayFragmentCount)) {
                config.streaming.delay.liveDelayFragmentCount =
            ...
            config.streaming.cmcd.rtpSafetyFactor = $scope.cmcdRtpSafetyFactor
                ? $scope.cmcdRtpSafetyFactor
                : null;
            config.streaming.cmcd.enabledKeys = $scope.cmcdEnabledKeys
                ? $scope._getFormatedCmcdEnabledKeys()
                : [];
        ...
        $scope.changeTrackSwitchMode = function (mode, type) {
            ...
            $scope.player.updateSettings({
                streaming: { trackSwitchMode: switchMode },
            });
        };
        ...
        $scope.setLogLevel = function () {
            ...
            switch (level) {
                ...
                case "error":
                    $scope.player.updateSettings({
                        debug: { logLevel: dashjs.Debug.LOG_LEVEL_ERROR },
                    });
                    break;
                ...
                case "info":
                    $scope.player.updateSettings({
                        debug: { logLevel: dashjs.Debug.LOG_LEVEL_INFO },
                    });
                    break;
        ...
        $scope.setCmcdMode = function () {
            ...
            switch (mode) {
                case "query":
                    $scope.player.updateSettings({
                        streaming: { cmcd: { mode: "query" } },
                    });
                    break;

                case "header":
                    $scope.player.updateSettings({
                        streaming: { cmcd: { mode: "header" } },
                    });
                    break;
        ...
        $scope.setDrm = function () {
            ...
            for (let input of drmInputs) {
                if (input.isActive) {
                    ...
                    if (
                        input.hasOwnProperty("inputMode") &&
                        input.inputMode === "kidKey"
                    ) {
                        ...
                        if (input.clearkeys !== {}) {
                            ...
                            if (this.prioritiesEnabled) {
                                for (let key in input.clearkeys) {
                                    protectionData[input.drmKeySystem][
                                        "clearkeys"
                                    ][key] = input.clearkeys[key];
                                }
                                protectionData[input.drmKeySystem]["priority"] =
                                    parseInt(input.priority);
                            } else {
                                for (let key in input.clearkeys) {
                                    protectionData[input.drmKeySystem][
                                        "clearkeys"
                            ...
                            for (let key in input) {
                                if (
                                    ...
                                    protectionData[input.drmKeySystem][key] =
                                        input[key];
                                }
                            }
        ...
        $scope.handleRequestHeaders = function () {
            ...
            for (let header of $scope.playreadyRequestHeaders) {
                $scope.drmPlayready.httpRequestHeaders[header.key] =
                    header.value;
            }
            for (let header of $scope.widevineRequestHeaders) {
                $scope.drmWidevine.httpRequestHeaders[header.key] =
                    header.value;
            }
            for (let header of $scope.clearkeyRequestHeaders) {
                $scope.drmClearkey.httpRequestHeaders[header.key] =
                    header.value;
            }
        };
        ...
        $scope.handleClearkeys = function () {
            ...
            if (
                $scope.drmClearkey.kid !== "" &&
                $scope.drmClearkey.key !== ""
            ) {
                $scope.drmClearkey.clearkeys[$scope.drmClearkey.kid] =
                    $scope.drmClearkey.key;
            }
            ...
            for (let data in protectionData) {
                switch (data) {
                    ...
                    case "com.microsoft.playready":
                        ...
                        $scope.drmPlayready.licenseServerUrl =
                            protectionData[data]["serverURL"];
                        for (let header in protectionData[data][
                            "httpRequestHeaders"
                        ]) {
                            $scope.playreadyRequestHeaders.push({
                                id: $scope.playreadyRequestHeaders.length + 1,
                                key: header,
                                value: protectionData[data][
                                    "httpRequestHeaders"
                                ][header],
                            });
                        }
                        ...
                        for (let parameter in protectionData[data]) {
                            if (
                                ...
                                $scope.drmPlayready[parameter] =
                                    protectionData[data][parameter];
                            }
                        }
                        break;
                    ...
                    case "com.widevine.alpha":
                        ...
                        $scope.drmWidevine.licenseServerUrl =
                            protectionData[data]["serverURL"];
                        for (let header in protectionData[data][
                            "httpRequestHeaders"
                        ]) {
                    ...
                    case "org.w3.clearkey":
                        ...
                        if (protectionData[data]["serverURL"] !== undefined) {
                            ...
                            for (let header in protectionData[data][
                                ...
                                $scope.clearkeyRequestHeaders.push({
                                    id:
                                        $scope.clearkeyRequestHeaders.length +
                                        1,
                                    key: header,
                                    value: protectionData[data][
                                        "httpRequestHeaders"
                        ...
                        // Handle clearkey data if specified using KID=KEY.
                            ...
                            if (protectionData[data]["clearkeys"] !== {}) {
                                for (let kid in protectionData[data][
                                    "clearkeys"
                                ]) {
                                    ...
                                    if (first === true) {
                                        ...
                                        $scope.drmClearkey.key =
                                            protectionData[data]["clearkeys"][
                                                kid
                                            ];
                                        delete protectionData[data][
                                            "clearkeys"
                                        ][kid];
                                        first = false;
                                    } else if (
        ...
        $scope.openDialogue = function (keySystem) {
            switch (keySystem) {
                case "playready":
                    document.getElementById(
                        "playreadyRequestHeaderDialogue"
                    ).style.display = "inline-block";
                    break;
                case "widevine":
                    document.getElementById(
                        "widevineRequestHeaderDialogue"
                    ).style.display = "block";
                    break;
                case "clearkey":
                    document.getElementById(
                        "clearkeyRequestHeaderDialogue"
                    ).style.display = "block";
                    break;
                case "additionalClearkeys":
                    document.getElementById(
                        "additionalClearkeysDialogue"
                    ).style.display = "block";
                    break;
            }
        };
        ...
        $scope.copyNotificationShow = function () {
            document.getElementById("copyNotificationPopup").style.display =
                "block";
        ...
        window.onclick = function (event) {
            if (
                event.target ==
                    document.getElementById("playreadyRequestHeaderDialogue") ||
                event.target ==
                    document.getElementById("widevineRequestHeaderDialogue") ||
                event.target ==
                    document.getElementById("clearkeyRequestHeaderDialogue") ||
                event.target ==
                    document.getElementById("additionalClearkeysDialogue")
            ) {
        ...
        $scope.copyQueryUrl = function () {
            var currentExternalSettings = {
                mpd: encodeURIComponent(
                    decodeURIComponent($scope.selectedItem.url)
                ),
            ...
            var externalSettingsString = $scope.toQueryString(
                $scope.makeSettingDifferencesObject(
                    currentExternalSettings,
                ...
                if (drm.isActive) {
                    switch (drm.drmKeySystem) {
                        case "com.microsoft.playready":
                            ...
                            externalSettingsString +=
                                "&" + $scope.toQueryString(currentDrm);
                            break;
                        case "com.widevine.alpha":
            ...
            currentSetting = $scope.makeSettingDifferencesObject(
                currentSetting,
                defaultSettings
            );
            ...
            var queryString =
                externalSettingsString +
                "+&" +
                $scope.toQueryString(currentSetting);
        ...
        $scope.makeSettingDifferencesObject = function (
            settings,
            defaultSettings
        ) {
            ...
            for (var setting in settings) {
                if (
                    typeof defaultSettings[setting] === "object" &&
                    defaultSettings[setting] !== null &&
                    !(defaultSettings[setting] instanceof Array)
                ) {
                    settingDifferencesObject[setting] =
                        this.makeSettingDifferencesObject(
                            settings[setting],
                    ...
                    if (Array.isArray(settings[setting])) {
                        settingDifferencesObject[setting] = _arraysEqual(
                            settings[setting],
                            defaultSettings[setting]
                        )
                            ? {}
        ...
        $scope.toSettingsObject = function (queryString) {
            ...
            for (var settingCategory of Object.keys(settingsObject)) {
                if (
                    ...
                    drmObject[settingCategory] =
                        settingsObject[settingCategory];
                    $scope.activeDrms[settingCategory] =
                        settingsObject[settingCategory];
            ...
            if (prioritiesEnabled !== undefined) {
                drmObject = $scope.makeProtectionData(
                    drmObject,
                    prioritiesEnabled
                );
            }
        ...
        $scope.makeProtectionData = function (drmObject, prioritiesEnabled) {
            ...
            for (var drm in drmObject) {
                if (
                    drmObject[drm].hasOwnProperty("inputMode") &&
                    drmObject[drm].inputMode === "kidKey"
                ) {
                    if (drmObject[drm].clearkeys !== {}) {
                        ...
                        if (prioritiesEnabled) {
                            for (var key in drmObject[drm].clearkeys) {
                                queryProtectionData[
                                    drmObject[drm].drmKeySystem
                                ]["clearkeys"][key] =
                                    drmObject[drm].clearkeys[key];
                            }
                            queryProtectionData[drmObject[drm].drmKeySystem][
                                "priority"
                            ] = parseInt(drmObject[drm].priority);
                        } else {
                            for (var key in drmObject[drm].clearkeys) {
                                queryProtectionData[
                                    drmObject[drm].drmKeySystem
                        ...
                        if (drmObject[drm].httpRequestHeaders !== {}) {
                            queryProtectionData[drmObject[drm].drmKeySystem][
                                "httpRequestHeaders"
                            ] = drmObject[drm].httpRequestHeaders;
                        }
                    } else {
                        alert("Kid and Key must be specified!");
                    }
                    ...
                    if (prioritiesEnabled) {
                        queryProtectionData[drmObject[drm].drmKeySystem] = {
                            serverURL: decodeURIComponent(
                                drmObject[drm].licenseServerUrl
                            ),
        ...
        $scope.setExternalSettings = function (currentQuery) {
            var handleExternalSettings = currentQuery
                .split("+")
                .join("")
                .split("&");
            for (
                var index = 0;
                index < handleExternalSettings.length;
                index++
            ) {
                var [key, value] =
                    handleExternalSettings[index].split("=") || "";
                switch (key) {
                    case "mpd":
                    ...
                    case "forceQualitySwitchSelected":
                        ...
                        $scope.toggleForceQualitySwitch(
                            $scope.forceQualitySwitchSelected
                        );
                        break;
                    ...
                    case "roleVideo":
                        ...
                        break;
                    case "languageText":
                        $scope.initialSettings.text =
                            $scope.handleQueryParameters(value);
                        $scope.player.setInitialMediaSettingsFor("text", {
                            lang: $scope.handleQueryParameters(value),
                        });
                        break;
                    case "roleText":
                        $scope.player.setInitialMediaSettingsFor("text", {
                            lang: $scope.handleQueryParameters(
                                $scope.initialSettings.text
                            ),
                            role: $scope.handleQueryParameters(value),
                        });
        ...
        $scope.setQueryData = function (currentQuery) {
            ...
            var passedSettings = currentQuery
                .slice(currentQuery.indexOf("+"))
                .substring(1);
            passedSettings = $scope.toSettingsObject(passedSettings)[0];
            $scope.protectionData = $scope.toSettingsObject(
        ...
        $scope.checkQueryLength = function (string) {
            ...
            if (string.length > maxUrlLength) {
                alert(
                    "The length of the URL may exceed the Browser url character limit."
                );
            }
        };
        ...
        function calculateHTTPMetrics(type, requests) {
            ...
            if (requestWindow.length > 0) {
                var latencyTimes = requestWindow.map(function (req) {
                    return (
                        Math.abs(
                            req.tresponse.getTime() - req.trequest.getTime()
                        ) / 1000
                    );
                });
                ...
                var downloadTimes = requestWindow.map(function (req) {
                    return (
                        Math.abs(
                            req._tfinish.getTime() - req.tresponse.getTime()
                        ) / 1000
                    );
                });
        ...
        $scope.enableChartByName = function (id, type) {
            ...
            if ($scope.chartState[type][id].selected) {
                ...
                if ($scope.chartData.length === $scope.maxChartableItems) {
                    alert(
                        "You have selected too many items to chart simultaneously. Max allowd is " +
                            $scope.maxChartableItems +
                            ". Please unselect another item first, then reselected " +
                            $scope.chartState[type][id].label
                    );
                ...
                //remove stat item from charts
                for (var i = 0; i < $scope.chartData.length; i++) {
                    if (
                        $scope.chartData[i].id === id &&
                        $scope.chartData[i].type === type
                    ) {
        ...
        function updateMetrics(type) {
            ...
            if (dashMetrics && $scope.currentStreamInfo) {
                var period = dashAdapter.getPeriodById(
                    $scope.currentStreamInfo.id
                );
                var periodIdx = period
                    ? period.index
                    : $scope.currentStreamInfo.index;

                var maxIndex = dashAdapter.getMaxIndexForBufferType(
                    type,
                    periodIdx
                );
                ...
                var droppedFramesMetrics =
                    dashMetrics.getCurrentDroppedFrames();
                var droppedFPS = droppedFramesMetrics
                ...
                var httpMetrics = calculateHTTPMetrics(
                    type,
                    dashMetrics.getHttpRequests(type)
                );
                if (httpMetrics) {
                    $scope[type + "Download"] =
                        httpMetrics.download[type].low.toFixed(2) +
                        " | " +
                        httpMetrics.download[type].average.toFixed(2) +
                        " | " +
                        httpMetrics.download[type].high.toFixed(2);
                    $scope[type + "Latency"] =
                        httpMetrics.latency[type].low.toFixed(2) +
                        " | " +
                        httpMetrics.latency[type].average.toFixed(2) +
                        " | " +
                        httpMetrics.latency[type].high.toFixed(2);
                    $scope[type + "Ratio"] =
                        httpMetrics.ratio[type].low.toFixed(2) +
                        " | " +
                        httpMetrics.ratio[type].average.toFixed(2) +
                        " | " +
                        httpMetrics.ratio[type].high.toFixed(2);
                }
        ...
        function setLatencyAttributes() {
            ...
            $scope.defaultStableBufferDelay =
                currentConfig.streaming.buffer.stableBufferTime;
            $scope.defaultBufferTimeAtTopQuality =
                currentConfig.streaming.buffer.bufferTimeAtTopQuality;
            $scope.defaultBufferTimeAtTopQualityLongForm =
                currentConfig.streaming.buffer.bufferTimeAtTopQualityLongForm;
            $scope.liveCatchupEnabled =
                currentConfig.streaming.liveCatchup.enabled;
            $scope.liveCatchupMode = currentConfig.streaming.liveCatchup.mode;
        }

        function setAbrRules() {
            var currentConfig = $scope.player.getSettings();
            $scope.additionalAbrRules.insufficientBufferRule =
                currentConfig.streaming.abr.additionalAbrRules.insufficientBufferRule;
            $scope.additionalAbrRules.switchHistoryRule =
                currentConfig.streaming.abr.additionalAbrRules.switchHistoryRule;
            $scope.additionalAbrRules.droppedFramesRule =
                currentConfig.streaming.abr.additionalAbrRules.droppedFramesRule;
            $scope.additionalAbrRules.abandonRequestsRule =
                currentConfig.streaming.abr.additionalAbrRules.abandonRequestsRule;
            $scope.ABRStrategy = currentConfig.streaming.abr.ABRStrategy;
            $scope.abrThroughputCalculationMode =
                currentConfig.streaming.abr.fetchThroughputCalculationMode;
        }

        function setAdditionalPlaybackOptions() {
            var currentConfig = $scope.player.getSettings();
            $scope.applyServiceDescription =
                currentConfig.streaming.applyServiceDescription;
            $scope.scheduleWhilePausedSelected =
                currentConfig.streaming.scheduling.scheduleWhilePaused;
            $scope.calcSegmentAvailabilityRangeFromTimelineSelected =
                currentConfig.streaming.timeShiftBuffer.calcFromSegmentTimeline;
            $scope.reuseExistingSourceBuffersSelected =
                currentConfig.streaming.buffer.reuseExistingSourceBuffers;
            $scope.localStorageSelected =
                currentConfig.streaming.lastBitrateCachingInfo.enabled;
            $scope.jumpGapsSelected = currentConfig.streaming.gaps.jumpGaps;
        }

        function setAdditionalAbrOptions() {
            var currentConfig = $scope.player.getSettings();
            $scope.fastSwitchSelected =
                currentConfig.streaming.buffer.fastSwitchEnabled;
            $scope.videoAutoSwitchSelected =
                currentConfig.streaming.abr.autoSwitchBitrate.video;
            $scope.customABRRulesSelected =
                !currentConfig.streaming.abr.useDefaultABRRules;
        }

        function setDrmOptions() {
            var currentConfig = $scope.player.getSettings();
            $scope.drmPlayready.priority =
                $scope.drmPlayready.priority.toString();
            $scope.drmWidevine.priority =
                $scope.drmWidevine.priority.toString();
            $scope.drmClearkey.priority =
                $scope.drmClearkey.priority.toString();
        }
        ...
        function setLiveDelayOptions() {
            ...
            $scope.liveDelayFragmentCount =
                currentConfig.streaming.delay.liveDelayFragmentCount;
            $scope.useSuggestedPresentationDelay =
                currentConfig.streaming.delay.useSuggestedPresentationDelay;
        }

        function setInitialSettings() {
            var currentConfig = $scope.player.getSettings();
            if (currentConfig.streaming.abr.initialBitrate.video !== -1) {
                $scope.initialVideoBitrate =
                    currentConfig.streaming.abr.initialBitrate.video;
            }
            if (currentConfig.streaming.abr.minBitrate.video !== -1) {
                $scope.minVideoBitrate =
                    currentConfig.streaming.abr.minBitrate.video;
            }
            if (currentConfig.streaming.abr.maxBitrate.video !== -1) {
                $scope.maxVideoBitrate =
                    currentConfig.streaming.abr.maxBitrate.video;
            }

            if ($scope.player.getInitialMediaSettingsFor("audio")) {
                $scope.initialSettings.audio =
                    $scope.player.getInitialMediaSettingsFor("audio").lang;
            }
            if ($scope.player.getInitialMediaSettingsFor("video")) {
                $scope.initialSettings.video =
                    $scope.player.getInitialMediaSettingsFor("video").role;
            }
            if ($scope.player.getInitialMediaSettingsFor("text")) {
                $scope.initialSettings.text =
                    $scope.player.getInitialMediaSettingsFor("text").lang;
            }
            if ($scope.player.getInitialMediaSettingsFor("text")) {
                $scope.initialSettings.textRole =
                    $scope.player.getInitialMediaSettingsFor("text").role;
            }

            $scope.initialSettings.textEnabled =
                currentConfig.streaming.text.defaultEnabled;
        }

        function setTrackSwitchModeSettings() {
            currentConfig = $scope.player.getSettings();
            initAudioTrackSwitchMode =
                currentConfig.streaming.trackSwitchMode.audio;
            $scope.audioTrackSwitchMode =
                currentConfig.streaming.trackSwitchMode.audio;
            initVideoTrackSwitchMode =
                currentConfig.streaming.trackSwitchMode.video;
            $scope.videoTrackSwitchMode =
                currentConfig.streaming.trackSwitchMode.video;
        }
        ...
        function setCMCDSettings() {
            ...
            if (currentConfig.streaming.cmcd.rtpSafetyFactor) {
                $scope.cmcdRtpSafetyFactor =
                    currentConfig.streaming.cmcd.rtpSafetyFactor;
            }

            $scope.cmcdMode = currentConfig.streaming.cmcd.mode;

            if (currentConfig.streaming.cmcd.enabledKeys) {
                $scope.cmcdEnabledKeys =
                    currentConfig.streaming.cmcd.enabledKeys;
            }
        }
            ...
            if (isAvailable) {
                ...
                castContext.addEventListener(
                    ...
                    function (e) {
                        console.log("[Cast]", e);
                        if (
                            e.castState === cast.framework.CastState.CONNECTED
                        ) {
                            onCastReady();
                        } else if (
                            e.castState ===
        ...
        function checkLocationProtocol() {
            if (
                ...
                // var out =
                //   "This page has been loaded under http. This can result in the EME APIs not being available to the player and <b>any DRM-protected content will fail to play</b>. " +
                //   "If you wish to test manifest URLs that require EME support, then <a href='https:" +
                //   window.location.href.substring(window.location.protocol.length) +
                //   "'>reload this page under https</a>.";
                var divContainer = document.getElementById(
                    "http-warning-container"
                );
